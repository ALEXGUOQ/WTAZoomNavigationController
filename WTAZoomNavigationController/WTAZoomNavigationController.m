...
- (WTAZoomNavigationController *)wta_zoomNavigationController
{
    ...
    if (!panNavigationController && [self wta_zoomNavigationController] != nil)
    {
...
{
    [[self scrollView] scrollRectToVisible:CGRectMake([[self scrollView] contentSize].width - CGRectGetWidth([[self scrollView] bounds]),
                                                      0.0f,
